...
export const investmentsData: Investment[] = [
  {
    ...
    apartments: [
      ...
      { id: '2a', price: '590000 zł',floor:1,rooms: 7, area: 67, status: 'dostępne',  description: 'Przestronny, dwupoziomowy apartament z dużym salonem i otwartą kuchnią. Idealny dla dużej rodziny, z prywatnym ogródkiem i bezpośrednim wyjściem na tereny zielone.',    galleryImages:[wizualizacja1,wizualizacja2,wizualizacja3,wizualizacja4,wizualizacja5], },

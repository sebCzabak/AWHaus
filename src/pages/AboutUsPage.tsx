...
export function AboutUsPage() {
  return (
    <>
      <title>Poznaj AWHaus - Deweloper z Pasją w Opolu | Nasza Historia</title>
      <meta
        name="description"
        content="AWHaus to deweloper budujący nowoczesne domy i mieszkania w Opolu i okolicach. Poznaj naszą historię, misję i zespół ekspertów gotowych spełnić Twoje marzenia."
      />
      ...
      >
        <Paper sx={{ p: { xs: 2, md: 4 } }}>
          ...
          <Typography paragraph>
            Od [rok założenia] roku z pasją tworzymy przestrzenie, które nasi klienci z dumą nazywają domem. Wierzymy,
            że kluczem do sukcesu jest połączenie nowoczesnej architektury, najwyższej jakości materiałów i
            transparentnej współpracy. Każdy projekt traktujemy indywidualnie, dbając o każdy, nawet najmniejszy detal.
          </Typography>

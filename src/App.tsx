    ...
    <ThemeProvider theme={theme}>
      <CssBaseline />
       <Box
        sx={{
          ...
          minHeight: '100vh', // Minimalna wysokość równa wysokości ekranu
        }}
      >
      <Header />
      <Box component="main" sx={{ flexGrow: 1 }}>
        <Routes>
          ...
          <Route path="/oferta/:investmentId" element={<SingleInvestmentPage />} />
          <Route path="/oferta/:investmentId/:apartmentId" element={<SingleApartmentPage />} />
          <Route path="/kontakt" element={<ContactPage />} />
          <Route path="/dziennik-budowy"element={<ConstructionDiaryPage/>}/>
          <Route path="/faq" element={<FAQPage />} />
          <Route path="/kalkulator-kredytowy" element={<CreditCalculatorPage />} />
          <Route path="/jak-pomagamy" element={<HowWeCanHelpPage />} />
